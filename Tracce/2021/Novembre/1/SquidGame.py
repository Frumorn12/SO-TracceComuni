...
class Player(Thread):
    ...
    def run(self):
        ...
        if aliveAndKicking == -1:
            self.game.shout(
                "Please please no no no no don't kill meeee aaaaaahhhh. [RIP Player %s]" % self.numero)  # self.game.shout(f"Please please no no no no don't kill meeee aaaaaahhhh. [RIP Player {self.numero}]")
        else:
            self.game.shout(
                "I'm aliveeeeeeeee. [Player %s survives beyond the line]" % self.numero)  # self.game.shout(f"I'm aliveeeeeeeee. [Player {self.numero} survives beyond the line]")
        self.game.barrierWait()
...
class StellaMaster(Thread):
    ...
    def run(self):
        ...
        print(
            "The timer ended with %d survivors. Proceeding to kill survivors still before the winning line." % viviAlloScadere)
        ...
        self.game.barrierWait()
        print(
            f"%d players participated. There were %d players alive at the end of the time. Then the game ended with %d survivors. Proceeding to next game." % (
            NUMPLAYERS, viviAlloScadere, viviAllaFine))
